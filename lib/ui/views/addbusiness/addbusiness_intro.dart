            ...
            children: [
             ...
             Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: Get.width*0.1),
                    child: AutoSizeText("BlackEco is a platform for listing your business, growing your business and a way to connect  with potential customers. By having your business on BlackEco you will be able to:",style: TextStyles.body1.copyWith(color: Colors.grey[500]),textAlign: TextAlign.center,),
                  )
                ],
              ),
             Padding(
                ...
                child: Container(
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: Get.height*0.01,),
                      Row(children: [
                        Container(height: Get.width*0.03,width: Get.width*0.03,decoration: BoxDecoration(shape: BoxShape.circle,color:Theme.of(context).primaryColorDark),),
                      ...
                      Row(children: [
                        Container(height: Get.width*0.03,width: Get.width*0.03,decoration: BoxDecoration(shape: BoxShape.circle,color: Theme.of(context).primaryColorDark),),
                        SizedBox(width:Get.width*0.05,),
                        Flexible(child: AutoSizeText("Get access to powerful advertising tools",presetFontSizes: [18,16],))
                      ],),
                      SizedBox(height: Get.height*0.01,),
                      Row(children: [
                        Container(height: Get.width*0.03,width: Get.width*0.03,decoration: BoxDecoration(shape: BoxShape.circle,color: Theme.of(context).primaryColorDark),),
