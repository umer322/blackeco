...
import 'package:blackeco/ui/admin/views/complain/compains_controller.dart';
...
class ComplainsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ComplainsController>(
            ...
            child: Padding(
              ...
              child: Row(children: [
                ...
                Flexible(child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AutoSizeText("Report Type",style: TextStyles.h2,),
                    SizedBox(height:Get.height*0.01),
                    Flexible(child: DropdownButtonFormField(
                      onChanged: controller.checkReportType,
                      decoration: InputDecoration(
                          enabledBorder:OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
                          focusedBorder:OutlineInputBorder(borderRadius: BorderRadius.circular(10))
                      ),
                      hint: AutoSizeText("type"),
                      items: ReportModel.adminReportTypes.map((e) => DropdownMenuItem(child: AutoSizeText(e),value: e,)).toList(),))
                  ],
                )),
              ],),
            ),
